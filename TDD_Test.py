...
class TestInch(unittest.TestCase):
    ...
    def test_Zero_feet_Zero_Inch_Happy(self):
        '''
        Description:
            this function is use to check zero feet equal zero inch , if non zero value then pass the case
        Parameter:
            self parameter
        Return:
            none
        '''
        Result = TDD_main.inch_Analyser.zero_feet_equal_to_zero_inch(2,1)
        self.assertEqual(Result,True)

    def test_Zero_feet_Zero_Inch_Sad(self):
        '''
        Description:
            this function is use to check zero feet equal zero inch , if zero value then raise the exception
        Parameter:
            self parameter
        Return:
            none
        '''
        Result = TDD_main.inch_Analyser.zero_feet_equal_to_zero_inch(0,0)
        with self.assertRaises(Exception):
